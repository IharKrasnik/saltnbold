<script>
	...
	let freebies = [
		$toolsObj['webflow-starters'],
		$toolsObj['scribbles'],
		$toolsObj['marketing-pack'],
		$toolsObj['simple-icon-svg-set'],
		$toolsObj['nice-web-icon-set'],
		$toolsObj['pitch-deck-templates']
	];
