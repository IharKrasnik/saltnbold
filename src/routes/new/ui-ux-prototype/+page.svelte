	...
	let form = {
		fields: [
			...
			},
			{
				...
				type: 'long-text',
				hint: `Focus single outcome to get better prototype. Decide what actually matters for your product to deliver the core value.`,
				isRequired: true
			},
			{
				name: 'references',
				...
				type: 'long-text',
				hint: `Be specific about your competitors and what exactly you love about them`,
				isRequired: true
			}
		]
	};
