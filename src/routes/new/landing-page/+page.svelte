<script>
	...
	let form = {
		cacheId: 'landing_page',
		buttonText: 'Get My Landing Page',
		fields: [
			{
				name: 'name',
			...
			},
			{
				...
				rows: 8,
				description: '',
				placeholder: `I'm building an app that will allow startup founders to launch their landing page in seconds with and generate AI.`,
				type: 'long-text',
				hints: [
			...
			{
				name: 'references',
				title: `What are some websites that you like?`,
				description: '',
				placeholder: `I love how clean and simple Linear landing page is (https://linear.app). Also love https://cal.com branding.`,
				type: 'long-text',
...
<div class="section-header">
	<h2 class="text-xl font-bold">Get your landing page</h2>
...
<div class="section-body">
	{#if $currentUser}
		<div class="w-full max-w-[600px]">
			...
			<div class="form-hint">💡 Leave empty if you don't have a website yet</div>
		</div>
		...
		<div class="mb-8">
			...
			<div class="form-hint">💡 The more details you share, the better prototype you'll get</div>
		</div>
		...
		<div class="mb-8">
			...
			<div class="form-hint">
				💡 Focus single outcome to get better prototype. Decide what actually matters for your
		...
		<div class="mb-8">
			...
			<textarea
				placeholder="competitorwebsite.com — I love their website; anotherwebsite2.com — I love how simple their UI is and their color scheme; website3 — the most popular competitor. Please keep the fonts large and give lots of white space."
				rows="4"
				class="w-full"
			/>

			<div class="form-hint">
				💡 Be specific about your competitors and what exactly you love about them
			</div>
		</div> -->
		</div>
	{:else}
